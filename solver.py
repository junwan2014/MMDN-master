...
from utils import rmse_batch, flip_channels, shuffle_channels_for_horizontal_flipping, rmse_batch_final,rmse_batch_final2
...
class Solver(object):
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            rmse, pre_pts = rmse_batch(out.cpu(), kps, tforms) # rmse: N numpy
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            Rmse1 = np.zeros([self.test_loader.dataset.__len__()])
